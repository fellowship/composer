...
@pytest.mark.parametrize("mode,initial_scale,finetune_fraction,delay_fraction,pin_sizes",
...
def test_invalid_hparams(mode: str, initial_scale: float, finetune_fraction: float, delay_fraction: float,
    ...
    with pytest.raises(ValueError):
        ProgressiveResizing(mode, initial_scale, finetune_fraction, delay_fraction, pin_sizes, False)


class TestProgressiveResizingAlgorithm:

    @pytest.fixture
    def pr_algorithm(self, mode, initial_scale, finetune_fraction, delay_fraction, pin_sizes, resize_targets):
        return ProgressiveResizing(mode, initial_scale, finetune_fraction, delay_fraction, pin_sizes, resize_targets)
